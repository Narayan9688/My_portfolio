      ...
      <Container id="projects">
        <Wrapper>
          ...
          <ToggleButtonGroup >
            ...
            <Divider />
            {toggle === 'others' ?
              <ToggleButton active value="others" onClick={() => setToggle('others')}>OTHER APP'S</ToggleButton>
              :
              <ToggleButton value="others" onClick={() => setToggle('others')}>OTHERS APP'S</ToggleButton>
            }
            <Divider />
